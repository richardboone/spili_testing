...
parser.add_argument('-data-dir', metavar='DIR',default="./outputs",
...
parser.add_argument('--beta', type=float, default=0.8,
                    help='loss function hyper-parameter')
...
def main():
    ...
    if args.eval:
        ...
        print(f"Accuracy of the network on the {len(dataset_eval)} test images: {eval_metrics['top1']:.3f}%")
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            train_metrics = train_one_epoch(
                ...
                amp_autocast=amp_autocast, loss_scaler=loss_scaler, model_ema=model_ema, mixup_fn=mixup_fn, beta=args.beta)
...
def train_one_epoch(
        ...
        loss_scaler=None, model_ema=None, mixup_fn=None, beta=None):
